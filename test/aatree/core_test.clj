...
(println "y" y)
(.flip bb)
(def Y (load-vector bb (lazy-opts)))
...
(put-aa elmb elm)
(.flip elmb)
(def ELM (load-sorted-map elmb (lazy-opts)))
...
(put-aa elm1b elm1)
(.flip elm1b)
(def ELM1 (load-sorted-map elm1b (lazy-opts)))
...
(put-aa elm12b elm12)
(.flip elm12b)
(def ELM12 (load-sorted-map elm12b (lazy-opts)))
