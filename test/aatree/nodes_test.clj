...
(def m1 (map-insert m0 (new MapEntry "1" 1001) RT/DEFAULT_COMPARATOR))
(pnodev m1 "m1")
(pnodev (map-del m1 "1" RT/DEFAULT_COMPARATOR) "m1 - 1")

(def m13 (map-insert m1 (new MapEntry "3" 1003) RT/DEFAULT_COMPARATOR))
(pnodev m13 "m13")
(println "m13 level" (.level m13))
(pnodev (map-del m13 "1" RT/DEFAULT_COMPARATOR) "m13 - 1")
...
(pnodev (map-insert m123 (new MapEntry "1" 1010) RT/DEFAULT_COMPARATOR) "m123 + 1")
...
(println (.next mi))
(println (.hasNext mi))
(println (map-index-of m123 "0" RT/DEFAULT_COMPARATOR))
(println (map-index-of m123 "1" RT/DEFAULT_COMPARATOR))
(println (map-index-of m123 "2" RT/DEFAULT_COMPARATOR))
(println (map-index-of m123 "3" RT/DEFAULT_COMPARATOR))
(println (map-index-of m123 "4" RT/DEFAULT_COMPARATOR))
